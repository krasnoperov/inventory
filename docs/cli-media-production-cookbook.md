...
the clip will be handed to a renderer. Video defaults to generated audio.
Current Veo models do not support `--no-audio`; describe dialogue, SFX, score,
or ambience in the prompt when the soundtrack matters.
