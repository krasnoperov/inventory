...
| Video | `video` | Inherit first reference, else `animation` | `image`, `video` | No | Yes | `video generate`, `video refine`, `video derive`; refs allowed for derive; no batch manifest |
