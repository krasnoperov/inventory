...
| `audio` | Audio output | Supported by authenticated upload/download, CLI inspection, and CLI website-job generation when a configured audio provider is enabled |
